...
namespace SRATAPV.Ventas.Vista
{
    public partial class frmCorteCaja : Form
    {
        ...
        private void sumarDenominaciones()
        {
            ...
            suma += decimal.TryParse(txt100.Text, out b100) ? b100 * 50 : 0;
            suma += decimal.TryParse(txt200.Text, out b200) ? b200 * 50 : 0;
            suma += decimal.TryParse(txt500.Text, out b500) ? b500 * 50 : 0;
            suma += decimal.TryParse(txt1000.Text, out b1000) ? b1000 * 50 : 0;
